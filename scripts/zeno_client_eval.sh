...
# Run zeno as client.
~/zeno -client -msgPublicAddr ${LISTEN_IP}:33000 -msgLisAddr 0.0.0.0:33000 -pkiLisAddr 0.0.0.0:44000 -pki ${PKI_IP}:33000 -pkiCertPath "~/cert.pem" > ~/zeno_client_${LISTEN_IP}.log
